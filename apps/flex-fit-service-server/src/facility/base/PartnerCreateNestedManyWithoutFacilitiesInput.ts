...
@InputType()
class PartnerCreateNestedManyWithoutFacilitiesInput {
...
export { PartnerCreateNestedManyWithoutFacilitiesInput as PartnerCreateNestedManyWithoutFacilitiesInput };
